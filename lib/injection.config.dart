...
import 'application/user_form/user_form_bloc.dart' as _i17;
import 'application/users/users_bloc.dart' as _i18;
...
import 'infrastructure/auth/firebase_auth_facade.dart' as _i20;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i16.UserBloc>(() => _i16.UserBloc(get<_i9.IUserRepository>()));
  gh.factory<_i17.UserFormBloc>(
      () => _i17.UserFormBloc(get<_i9.IUserRepository>()));
  gh.factory<_i18.UsersBloc>(() => _i18.UsersBloc(get<_i9.IUserRepository>()));
  gh.lazySingleton<_i19.IAuthFacade>(() => _i20.FirebaseAuthFacade(
